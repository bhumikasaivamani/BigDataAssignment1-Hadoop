...
public class ListMoviesByGenre 
{
    ...
    public static class Map extends Mapper<LongWritable,Text,Text,Text>
    {
        ...
        {
            String genre="Action"; //check
            String line=value.toString();
            String [] tokenizedLine=line.split("::");
            
            String movieTitle=tokenizedLine[1];
            String genreValue=tokenizedLine[2];
            
            if(genreValue.contains(genre))
            {
                context.write(new Text(key.toString()),new Text(movieTitle));
            }
    ...
    public static void main(String args[])throws Exception
    {
        ...
        Job job = new Job(configuration, "ListMoviesByGenre");
